...
const strings = {
  ...
  'orders.billedKilos': { tl: 'sisingilin {n} kg — minimum', en: 'billed {n} kg — minimum' },
  'orders.addService': { tl: '+ Dagdag na serbisyo', en: '+ Add another service' },
  'orders.removeService': { tl: 'Alisin ang serbisyo', en: 'Remove this service' },
  'orders.serviceLine': { tl: 'Serbisyo {n}', en: 'Service {n}' },
  ...
  'payments.record': { tl: 'Tanggapin ang bayad', en: 'Record payment' },
  /** Table-header form: the row control is an icon, so the verb is stated once per column. */
  'payments.recordShort': { tl: 'Bayad', en: 'Record' },
  ...
  'payments.paymentDate': { tl: 'Huling bayad', en: 'Payment date' },
  'payments.noPaymentYet': { tl: 'Wala pa', en: 'None yet' },
  'payments.paymentCount': { tl: { one: '{n} bayad', other: '{n} bayad' }, en: { one: '{n} payment', other: '{n} payments' } },
  'payments.showing': { tl: 'Nakikita', en: 'Showing' },
  'payments.clearFilter': { tl: 'Ipakita lahat', en: 'Show all' },
  'payments.scope.today': { tl: 'Nakolekta ngayong araw', en: 'Collected today' },
  'payments.scope.month': { tl: 'Nakolekta ngayong buwan', en: 'Collected this month' },
  'payments.scope.outstanding': { tl: 'Balanse, pinakamalaki muna', en: 'Outstanding, largest first' },
  'payments.scope.unpaid': { tl: 'Orders na may balanse', en: 'Orders with balance' },
  'payments.scope.aging': { tl: 'Balanse na {bucket}', en: 'Balance owing {bucket}' },
  'payments.emptyToday': { tl: 'Wala pang bayad ngayong araw.', en: 'No payments collected today yet.' },
  'payments.emptyMonth': { tl: 'Wala pang bayad ngayong buwan.', en: 'No payments collected this month yet.' },
  'payments.emptyBucket': { tl: 'Walang balanse sa hanay na ito.', en: 'No balances in this range.' },
