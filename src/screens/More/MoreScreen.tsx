...
export function MoreScreen() {
  ...
  const items = [
    { to: '/more/reports', key: 'more.reports', icon: '📊', ownerOnly: true },
    { to: '/more/services', key: 'more.services', icon: '🧼', ownerOnly: true },
    { to: '/more/inventory', key: 'more.inventory', icon: '📦', ownerOnly: false },
    { to: '/more/users', key: 'more.users', icon: '🔑', ownerOnly: true },
    { to: '/more/backup', key: 'more.backup', icon: '💾', ownerOnly: false },
    { to: '/more/settings', key: 'more.settings', icon: '⚙️', ownerOnly: true },
    { to: '/more/help', key: 'more.help', icon: '❓', ownerOnly: false },
  ] as const
